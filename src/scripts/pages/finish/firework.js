...
//  var aaaimageData = context.getImageData(0,0,SCREEN_WIDTH, SCREEN_HEIGHT);
//   var aaadata = aaaimageData.data;
    
//     for (var i = 0; i < aaadata.length; i += 4) {
//       if(aaadata[i]<50 && aaadata[i+1]<50 && aaadata[i+2]<50){
//         aaadata[i+3]=0;
//       }
//     }
//     context.putImageData(aaaimageData, 0, 0);
      //*******************



      // context.drawImage(options.img,0,0,SCREEN_WIDTH, SCREEN_HEIGHT);
			//context.save();
