    ...
    return (
      <div className={style.root} >
        ...
        <div className={style.items}>
          ...
          <img className={style.item} src={ window.dominContext.staticPath + '/assets/images/start/start_logo.png' } alt="" />
        </div>
        <p className={style.info}>{"各系统运行正常，切换工作准备就绪!"}</p>
        <Link className={style.start} to="/datamigration">
          <img src={ window.dominContext.staticPath + '/assets/images/start/start.png' }></img>
        </Link>        
