  ...
  render() {
    return (
      <div className={this.props.className}>
        ...
        <PlanBar curR={this.props.curR}/>
        <div className={style.startTime}>
          <span>启动时间</span>
          <p className={style.date}>{moment(this.props.startTime*1000).format('M/DD')}<span className={style.time}>{moment(this.props.startTime*1000).format('HH:mm:ss')}</span></p>
        </div>
