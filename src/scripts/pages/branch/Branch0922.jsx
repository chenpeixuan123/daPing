...
export default class Branch extends Component {
    ...
    componentDidMount() {
        ...
        setInterval(self.getaqdzbData, window.locationConfig.ZTInterface.interface.linkLogin.loopTime);
    }
    ...
    getaqdzbData = () => {
        ...
        if (window.locationConfig.debug) {
            ...
            //             //     this.qdzb
            //             // );
            Tools.fetchGet(/*window.locationConfig.NInterface.interface.qdzb.address + '?=dcId=2012&filter={"name":"Q1000001"}'*/
        ...
        return (
            <div className={style.BranchIndex}>
                ...
                <div style={{
                    ...
                    <div
                        className={style1.title}>{det['名称'].replace("(一级分支行)", "") == "甘肃银行股份有限公司" ? det['名称'].replace("(一级分支行)", "") : det['名称'].replace("(一级分支行)", "").replace("甘肃银行股份有限公司", "")}</div>
                    <div style={{
                        position: 'absolute',
                        top: '86px',
                        left: '30px',
                        ...
                        <div className={style1.zcfzze}>
                            ...
                            <img src={this.state.dkzeRadio >= 0 ? upA : downA}
                                 className={this.state.dkzeRadio >= 0 ? style.upArrow : style.downArrow}/>
                            <div className={style.ztsub}>{Math.abs(this.state.dkzeRadio).toFixed(2)}</div>
                        </span>
                            </p>
                        </div>
                        ...
                        <div className={style1.zcfzze}>
                            ...
                            <img src={this.state.kczeRadio >= 0 ? upA : downA}
                                 className={this.state.kczeRadio >= 0 ? style.upArrow : style.downArrow}/>
                            <div className={style.ztsub}>{Math.abs(this.state.kczeRadio).toFixed(2)}</div>
                        </span>
                            </p>
                        </div>
                        <div className={style1.zcfzze}>
                            <p className={style1.zcfzzeName}>中间业务收入总额（亿元）</p>
                            <p className={style1.zcfzzeValue}>1,726,13
                                <span style={{position: 'absolute', left: '172px'}}>
                            <img src={this.state.zjywsrzeRadio >= 0 ? upA : downA}
                                 className={this.state.zjywsrzeRadio >= 0 ? style.upArrow : style.downArrow}/>
                            <div className={style.ztsub}>{Math.abs(this.state.zjywsrzeRadio).toFixed(2)}</div>
                        </span>
                            </p>
                        </div>
                    </div>
        ...
        /> */}
                ...
                <ul style={{position: 'absolute', top: 848, left: 994}}>
                    ...
                    <li className={style1.ulli}>
                        ...
                        <div style={{width: 100, position: 'absolute', left: 282}}>当日新增</div>
                        <CountUp style={{width: 100, position: 'absolute', color: '#77C5FA', left: 389}} start={0}
                                 end={this.state.customer.account.today}
                                 separator=","
                        />
                        <div style={{width: 100, position: 'absolute', left: 543}}>本年新增</div>
                        <CountUp style={{width: 100, position: 'absolute', color: '#77C5FA', left: 658}} start={0}
