...
export default class Branchdp extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            //     name: "智能柜面",
            //     value: 498202
            // }, {name: "自助渠道", value: 91650}, {name: "智能柜台", value: 32869}, {name: "电子渠道", value: 3554558}]),
            detailsLine: {
                //净利润趋势分析
                ylTrend: {
                    yl: [],
        ...
        return (
            <div className={style.BranchIndex}>
                ...
                <ItemGauge
                    ...
                    data={{title: "贷款任务完成率", r: 75, min: 0, max: 1, value: this.state.dkrwwcl, radian: 170}}
                />
                <ItemGauge
                    style={{position: "absolute", left: 1606, top: 649, width: 170, height: 170}}
                    data={{title: "存款任务完成率", r: 75, min: 0, max: 1, value: this.state.ckrwwcl, radian: 170}}
                />
