...
class Info extends Component {
  ...
  sortFun = (a, b) => {
    if (a.TASK_ACT_FINISH_TIME == b.TASK_ACT_FINISH_TIME) {
      return 0;
    } else if (a.TASK_ACT_FINISH_TIME > b.TASK_ACT_FINISH_TIME) {
      return -1;
    } else {
      return 1;
    }
  ...
  render() {
    let arr = R.filter(R.propEq('TASK_SEND_STATUS', "3"), this.props.data);
